...
Rectangle {
  ...
  readonly property real scaleFactor: (typeof shellConfigService !== "undefined") ? shellConfigService.islandWidthScale : 1.0
  readonly property real baseBarHeight: (typeof shellConfigService !== "undefined") ? shellConfigService.barHeight : 34

  readonly property real hudWidth: 250 * scaleFactor
  readonly property real hudHeight: baseBarHeight
  readonly property real idleWidth: (isCustomActive ? 140 : 115) * scaleFactor
  readonly property real hoveredWidth: (isCustomActive ? 410 : 420) * scaleFactor
  readonly property real idleHeight: Math.max(24, baseBarHeight - 4)
  readonly property real hoveredHeight: baseBarHeight + 10
