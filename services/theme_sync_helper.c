...
static void sync_qt(const char *theme_id, const char *pdir, const char *home) {
    ...
    snprintf(src_qt, sizeof(src_qt), "%s/app_configs/qt/%s.conf", pdir, theme_id);
    snprintf(src_kdeglobals, sizeof(src_kdeglobals), "%s/app_configs/dolphin/%s.kdeglobals", pdir, theme_id);
...
static void sync_kitty(const char *theme_id, const char *pdir, const char *home) {
    ...
    snprintf(src, sizeof(src), "%s/app_configs/kitty/%s.conf", pdir, theme_id);
...
static void sync_zed(const char *theme_id, const char *pdir, const char *home) {
    ...
    snprintf(src, sizeof(src), "%s/app_configs/zed/%s.json", pdir, theme_id);
...
static void sync_zen(const char *theme_id, const char *pdir, const char *home) {
    ...
    snprintf(src_css, sizeof(src_css), "%s/app_configs/zen/%s.css", pdir, theme_id);
...
static void sync_nvim(const char *theme_id, const char *pdir, const char *home) {
    ...
    snprintf(src, sizeof(src), "%s/app_configs/nvim/%s.lua", pdir, theme_id);
...
static void sync_tmux(const char *theme_id, const char *pdir, const char *home) {
    ...
    snprintf(src, sizeof(src), "%s/app_configs/tmux/%s.conf", pdir, theme_id);
...
int main(int argc, char *argv[]) {
    ...
    if (len != -1) {
        ...
        if (last_slash) {
            *last_slash = '\0'; // e.g. .../services
            char *parent_slash = strrchr(exe_path, '/');
            if (parent_slash) {
                *parent_slash = '\0'; // e.g. .../OgsShell-qs
