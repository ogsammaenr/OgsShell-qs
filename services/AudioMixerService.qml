...
Item {
  ...
  Process {
    id: restoreProcess
    command: ["/home/excalibur/WorkSpace/projects/OgsShell-qs/services/audio_mixer_helper.py", "--restore"]
    running: false
    onExited: {
      service.refresh();
    }
  ...
  Process {
    id: refreshProcess
    command: ["/home/excalibur/WorkSpace/projects/OgsShell-qs/services/audio_mixer_helper.py", "--json"]
    running: false
  ...
  function setDefaultSink(sinkName) {
    ...
    Quickshell.execDetached(["/home/excalibur/WorkSpace/projects/OgsShell-qs/services/audio_mixer_helper.py", "--set-default", sinkName]);
  }
  ...
  function setMediaVolume(pct) {
    ...
    Quickshell.execDetached(["/home/excalibur/WorkSpace/projects/OgsShell-qs/services/audio_mixer_helper.py", "--set-media-vol", pct.toString()]);
  }

  function setMediaMute() {
    service.mediaMuted = !service.mediaMuted;
    Quickshell.execDetached(["/home/excalibur/WorkSpace/projects/OgsShell-qs/services/audio_mixer_helper.py", "--set-media-mute"]);
  }
}
